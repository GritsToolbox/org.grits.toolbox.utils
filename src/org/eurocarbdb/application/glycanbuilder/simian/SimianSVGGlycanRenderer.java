...
public class SimianSVGGlycanRenderer extends GlycanRendererAWT {


	public SimianSVGGlycanRenderer(GlycanRendererAWT src) {
	...
	public void paint(SimianGroupingSVGGraphics2D g2d, Glycan structure, HashSet<Residue> selected_residues, HashSet<Linkage> selected_linkages, boolean show_mass, boolean show_redend, PositionManager posManager, BBoxManager bboxManager) {    
	...
	public void paintResidue(SimianGroupingSVGGraphics2D g2d, Glycan structure,Residue node, HashSet<Residue> selected_residues, HashSet<Linkage> selected_linkages, PositionManager posManager, BBoxManager bboxManager) {    
		if( node==null )
			return;
	...
	public void paintBracket(SimianGroupingSVGGraphics2D g2d, Glycan structure, Residue bracket, HashSet<Residue> selected_residues, HashSet<Linkage> selected_linkages, PositionManager posManager, BBoxManager bboxManager) {    
		if( bracket==null )
			return;
