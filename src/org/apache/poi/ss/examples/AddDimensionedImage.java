...
public class AddDimensionedImage {
    ...
    protected static final int EMU_PER_MM = 36000;
     ...
     */
    protected ClientAnchorDetail fitImageToColumns(Sheet sheet, int colNumber,
     ...
     */
    protected ClientAnchorDetail fitImageToRows(Sheet sheet, int rowNumber,
     ...
     *         as a specific number of coordinate positions.
     */
    protected ClientAnchorDetail calculateColumnLocation(Sheet sheet,
                                                       int startingColumn,
     ...
     */
    protected ClientAnchorDetail calculateRowLocation(Sheet sheet,
